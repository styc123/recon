...
dfframe.columns = ["Order Date", 'Order ID','Platform','Brand','Subtotal','Tip','Other Amount','Processing Fee','Tax','Tax Withheld','Tax Delta','Adjustment','Commission','Payout']
dfframe1 = dfframe.loc[dfframe["Order ID"].notnull(),['Order Date','Order ID','Platform','Brand','Subtotal','Tip','Other Amount','Processing Fee','Tax','Tax Withheld','Tax Delta','Adjustment','Commission','Payout']]
...
with n5:
    check = st.checkbox('Partners', key = 'estimatedpayout')
with n6:
...
with n8:
    if df_act < df_exp:
        cautionicon = st.write("⚠️")
        check1 = st.checkbox("Partners", key = 'actualpayout')
    else:
        check1 = st.checkbox("Partners", key = 'actualpayout')
if check and check1:
    n1, n2, n3, n4, n5, n6, n7, n8, n9 = st.columns([1,1,1,2,1,1,2,1,1])
